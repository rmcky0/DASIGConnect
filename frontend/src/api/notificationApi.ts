...
/**
 * Opens a fetch-based SSE connection to /notifications/stream.
 * EventSource doesn't support Authorization headers, so we use fetch + ReadableStream.
            ...
            if (line.startsWith("event:")) {
              ...
              if (evtName === "notification") {
                try {
                  ...
                  console.debug("SSE: malformed JSON payload, skipping event", parseErr);
                }
              }
              evtName = "";
              data = "";
